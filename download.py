...
from file_utils import decompress, download
...
def download_voc2012(downloads_dir='data/downloads/', data_dir='data/datasets/', force=False):
    ...
    decompress(filepath, 'tar', data_dir, force=force)
...
def download_cityscapes(downloads_dir='data/downloads/cityscapes/', data_dir='data/datasets/cityscapes/', force=False):
    ...
    for filepath in filepaths:
        decompress(filepath, 'zip', data_dir, force=force)


def download_pretrained_models(models=('resnet_50', 'resnet_101', 'mobilenet_1.0_224'), downloads_dir='data/downloads/', model_dir='data/models/pretrained/', force=False):
    '''
    ...
    for model in models:
        ...
        decompress(filepath, 'tar', os.path.join(model_dir, model), force=force)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--force', help='force downloading and decompressinging files that are already present', default=False, action='store_true')
